    ...
    @endif
				...
				<div class="col-xl-12">
						<div class="card">
							...
							<button type="button" class="btn btn-primary-gradient btn-block" data-toggle="modal" data-target="#exampleModal"><i class="fas fa-plus"></i>&nbsp; اضافة منتج</button><br><br>
								</div>
							</div>
							<div class="card-body">
									...
									<table class="table text-md-nowrap" id="example1"  data-page-length="50">
										<thead>
											<tr>
												...
												<th class="wd-20p border-bottom-0">إسم القسم</th>
